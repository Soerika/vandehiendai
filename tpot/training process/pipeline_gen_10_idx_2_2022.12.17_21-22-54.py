...
# Average CV score on the training set was: -75969.6949102379
exported_pipeline = make_pipeline(
    ...
    MinMaxScaler(),
    StackingEstimator(estimator=RandomForestRegressor(bootstrap=False, max_features=0.35000000000000003, min_samples_leaf=16, min_samples_split=13, n_estimators=100)),
