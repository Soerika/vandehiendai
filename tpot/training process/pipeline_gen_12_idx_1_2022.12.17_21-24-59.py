...
# Average CV score on the training set was: -77091.32914694268
exported_pipeline = make_pipeline(
    ...
    ExtraTreesRegressor(bootstrap=True, max_features=0.8500000000000001, min_samples_leaf=1, min_samples_split=2, n_estimators=100)
)
